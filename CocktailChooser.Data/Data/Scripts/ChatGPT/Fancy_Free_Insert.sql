...
SELECT 'Fancy Free', 'Fruity and Complex', 'Combine ingredients in a shaker with ice. Shake. Strain into a chilled martini glass. Garnish with a lemon zest twist.', NULL, (SELECT Id FROM CocktailTimePeriods WHERE Period = 'Classic'), 0, 1
...
INSERT INTO Amounts (MeasurementName, Ounces) 
SELECT '2 Dashes', NULL
WHERE NOT EXISTS (SELECT 1 FROM Amounts WHERE MeasurementName = '2 Dashes');
